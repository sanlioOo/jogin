...
background.src = "assets/cenario.jpeg";

const background2 = new Image();
background2.src = "assets/cenario.jpeg"; // segunda imagem de fundo

const player = new Image();
player.src = "assets/player.png";

const ouroBranco = new Image();
ouroBranco.src = "assets/pocao.png";

const barraOuro = new Image();
barraOuro.src = "assets/pocao.png";
...
playerPasso1.src = "assets/passo.png";

const playerPasso2 = new Image();
playerPasso2.src = "assets/passo3.png";


const gatoPasso0 = new Image();
gatoPasso0.src = "assets/gatosf.png";

const gatoPasso1 = new Image();
gatoPasso1.src = "assets/gatosf2.png";

const gatoPasso2 = new Image();
gatoPasso2.src = "assets/gatosf.png"; // **CORRIGIDO: Era gatoPassos2, deve ser gatoPasso2**
...
// Tamanhos dos itens
const ouroBrancoSize = 40;
const barraOuroSize = 40;
...
const velocidadeAnimacaoGato = 8;
const gatoX = 300;
const gatoY = 260;
const gatoWidth = 70;
const gatoHeight = 70;
...
function resetGame() {
    ...
    canJump = true;
    gameState = "playing";
    // *** AQUI ESTÁ A CORREÇÃO: Limpar o estado das teclas ***
    keys = {};
}
...
function drawScoreAndLevel() {
    ...
    const texto1 = `Poçoes: ${score}/${ourosParaProximoNivel}`;
